...
async function createServer(isProd = process.env.NODE_ENV === "production") {
  ...
  app.use("*", async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      // 1. Read index.html
      let template = await fs.readFile(isProd ? resolve("dist/index.html") : resolve("../index.html"), "utf-8");
      ...
      let productionBuildPath = path.join(__dirname, "../dist/ssr/entry-server.mjs");
